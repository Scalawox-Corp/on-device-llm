...
| [Page Assist](https://chromewebstore.google.com/detail/page-assist-a-web-ui-for/jfgfiigpkhlkbnfnbobbkinehhgmcaeeh) | `nvidia/nemotron-3-nano-30b-a3b`, `qwen/qwen3.5-35b-a3b`, `nvidia/nemotron-3-nano-4b` | 브라우저 사이드바는 응답 속도 우선 — MoE로 빠른 추론 확보, 4B 경량 모델은 초고속 응답용 |
...
| [qwen/qwen3.5-35b-a3b](https://huggingface.co/Qwen/Qwen3.5-35B-A3B)                                       | Qwen   | 35B·3B활성   | 256 experts MoE로 3B 활성 파라미터 속도에 35B급 품질. 멀티모달(이미지·영상·오디오) 지원           | 262144    | Q4_K_M | ~22 GB | ~30–45 t/s  |
...
| [nvidia/nemotron-3-nano-4b](https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Nano-4B-GGUF)                 | NVIDIA | 4B         | Hybrid Mamba-Transformer 경량 모델. Nemotron Nano 9B에서 pruning+증류. 초고속 응답용 | 262144    | Q8_0   | ~4 GB  | ~80–100 t/s |
